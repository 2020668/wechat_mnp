...
class LoginPageLocator(object):
    ...
    # 手机号登录 手机号输入框
    phone_input_loc = MobileBy.ID, "com.tencent.mm:id/m7"

    # 短信验证码登录按钮
    msg_code_login_button_loc = MobileBy.ID, "com.tencent.mm:id/d1k"

    # 获取验证码按钮
    get_msg_code_button_loc = MobileBy.ID, "com.tencent.mm:id/dkp"

    # 验证码输入框
    msg_code_input_loc = MobileBy.ID, "com.tencent.mm:id/m7"

    # 用密码登录按钮
    pwd_login_button_loc = MobileBy.ID, "com.tencent.mm:id/d1k"

    # 密码输入框
    pwd_input_loc = MobileBy.ID, "com.tencent.mm:id/m6"

    # 登录按钮
    login_button_loc = MobileBy.ID, "com.tencent.mm:id/d17"
